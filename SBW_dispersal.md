...
editor_options:
  ...
  bibliography: citations/references_SBW_dispersal.bib
link-citations: true
always_allow_html: true
---

# SBW_dispersal Module

<!-- the following are text references used in captions for LaTeX compatibility -->
(ref:SBW-dispersal) *SBW_dispersal*
...
If `sourceURL` is specified, `downloadData("SBW_dispersal", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")` may be sufficient.
Table \@ref(tab:moduleInputs-SBW-dispersal) shows the full list of module inputs.

<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleInputs-SBW-dispersal)(\#tab:moduleInputs-SBW-dispersal)List of (ref:SBW-dispersal) input objects and their description.</caption>
 <thead>
  <tr>
...
Provide a summary of user-visible parameters (Table \@ref(tab:moduleParams-SBW-dispersal))


<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleParams-SBW-dispersal)(\#tab:moduleParams-SBW-dispersal)List of (ref:SBW-dispersal) parameters and their description.</caption>
 <thead>
  <tr>
...
Description of the module outputs (Table \@ref(tab:moduleOutputs-SBW-dispersal)).

<table class="table" style="color: black; margin-left: auto; margin-right: auto;">
<caption>(\#tab:moduleOutputs-SBW-dispersal)(\#tab:moduleOutputs-SBW-dispersal)List of (ref:SBW-dispersal) outputs and their description.</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> objectName </th>
   <th style="text-align:left;"> objectClass </th>
